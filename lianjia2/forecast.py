...
class forecast:
    ...
    def get_price_forecast(data):
        ...
        #  添加自定义预测数据
        new_data.loc[1926] = [None, 88.0, 2.0, 1.0, 1.0]
        new_data.loc[1927] = [None, 136.0, 3.0, 2.0, 2.0]
        data_train = new_data.loc[0:1926]
        ...
        print('真实值与预测值分别为：\n', new_data[['总价', 'y_pred']])
        y = new_data[['总价']][1820:int(len(new_data) - 2)]  # 获取2490以后的真实总价
        y_pred = new_data[['y_pred']][1820:]  # 获取2490以后的预测总价
